define(['jquery', 'cui', 'kind', 'css!tooltipStyle'], function($, cui, kind) {
    // Constants
    var ID_SUFFIX = '_tooltip';
    var DATA_ATTR_PREFIX = 'tt'; // For example, the 'tt' in `data-tt-my-custom-attribute`
    var DEFAULT_WIDTH = 400;
    var MESSAGE_TYPES = ['error', 'warning', 'info', 'success'];
    var VERSION = {
            name: 'tooltip',
            version: '1.0.0',
            date: '20010101'
    ...
    var _events = {};
    var _tooltipList = {}; // List of all created tooltips and their properties
    var _configs = {};
    var _linkSelectors = '.tooltip';

    // Default tooltip object. Instances of this object are usually named 'TT' within JS functions.
    var _defaultTooltipObj = {
            configId: 'default',
    ...
    var Tooltip = function _Tooltip(elem, options) {
        ...
        // basis. For example,
        // <div class='item' data-tooltip-options='{"message":"Goodbye World!"}'></div>
        this.metadata = this.$elem.data('tooltip-options');
    };
    ...
    // $(document).ready(Tooltip.prototype.init);
